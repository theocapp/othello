...
from services.briefing_service import get_before_news_archive_payload, get_briefing_payload, get_predictions_payload
...
def before_news_archive(limit: int = 50, minimum_gap_hours: int = 0):
    return get_before_news_archive_payload(limit=limit, minimum_gap_hours=minimum_gap_hours)
